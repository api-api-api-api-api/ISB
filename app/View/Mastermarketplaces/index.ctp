<?php
     echo $this->Html->script('h1mastermarketplace.js');
...
<div class="row">
    <blockquote>MASTER MARKETPLACE</blockquote>
</div>
<div class="row">
    <hr>
    <div class='col-md-8'>
        <div class="row">   
            <div class="form-group"><label class="control-label"> <i class="fa fa-search fa-fw"></i> FILTER BY:  </label></div>
                <div class="form-group">
                    <input type="text" name="txtNamaMarketplacefilter" id="txtNamaMarketplacefilter" class="form-control" style="width:250px;margin-bottom:0;font-size:11px;" placeholder="Nama Marketplace" onkeyup="if(event.keyCode === 13){getData(1)}"></div>
                <div class="form-group">
            ...
            <button type="button" class='btn btn-default btn-sm'  id="btnAdd"><i class="fa fa-plus-circle"> </i> TAMBAH MARKETPLACE</button><hr>
        </div>
    </div>
    <div class="col-md-8">
        <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-heading" >
                    <div class="row">
                        <div class="col-md-6"><label class="control-label"><i class="fa fa-th-list fa-fw"></i> RECORD DATA MARKETPLACE</label></div>
                    </div>
                </div>
                <div class="panel-body" style="overflow-x:auto; padding-top:0;padding-bottom:0;" >
                    <div class="row">
                        <table  id='tableMastermarketplace' cellpadding="0" cellspacing="0" width="100%" class="table" style="border-radius: 5px;margin-bottom:0;"> 
                            <thead>
                                <tr class="active">
                                    ...
                                    <th width="70%" style="text-align:left;vertical-align:middle">Nama Marketplace</th>      
        ...
        <div class="">
            <div class="panel panel-default">
                <div class="panel-body">
                    <dl>
                        <dt>Keterangan</dt>
                        <dd>Klik tombol <button type="button" class='btn btn-default btn-sm'><i class="fa fa-plus-circle"> </i> TAMBAH MARKETPLACE</button> untuk melakukan penambahan data</dd>
                        <dd>Klik tombol <button type='button' class='btn btn-xs btn-default'><i class='fa fa-edit fa-lg' style='margin: 5px 5px;'></i></button> untuk melakukan perubahan nama  dan/atau status Marketplace</dd>
                    </dl>
...
<!-- Modal Form -->
    <div class="modal fade"  id="modalFormMastermarketplace" role="dialog" aria-labelledby="modalFormMaintenanceUser" style="margin-top: 2%;outline: 0;">
                ...
                <div class="modal-body" style="overflow-y:auto;">
                    ...
                    <!-- col-md-offset-1 -->
                        <div class="col-md-12 ">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <input type="hidden" name="marketplaceID" id="marketplaceID">
                                    <!-- <p class="bg-info" style="padding: 15px;font-weight:bold;font-size:14px;" id="txtNoteReturn">test</p> -->
                                    <div class="form-horizontal">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">NAMA MARKETPLACE</label>
                                                <div class="col-md-8"><input class="form-control" type="text" id="namaMarketplace" name="namaMarketplace"  style="min-width:200px;"></div>
                                            </div>
                                            <div class="form-group" >

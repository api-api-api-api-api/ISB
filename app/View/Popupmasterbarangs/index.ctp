<?php
$this->layout='popup';
echo $this->Html->script('h1popupmasterbarang.js');
...
<script type='text/javascript'>
	...
	//console.log(obj_caller.$("#btnAksi").val())
</script>
<style type="text/css">
	...
	.labelForm{width: 100%;padding: 6px;border: 1px solid #ccc;border-radius: 4px;box-sizing: border-box;resize: vertical; display: block;background-color: #eee;opacity: 0.7;min-height: 28px;}
...
<form class="frmInput" name="masterBarangForm" method="post" style="width:100%; background-color:#FFF !important;" >
	...
	<div class="container">
				<div class="row">
					...
					<div class="col-75">
						<input type="text" id="namaBrg" class='input' name="txtNamaBrg" placeholder="Nama Barang">
						<label id="labelNamaBarang" class='labelForm' style="display:none;">Nama Barang </label>
					</div>
				</div>
				...
				<div class="row" style="display: none">
					...
					<div class="col-75">
						<input type="text" class='input' id="editAbleVal" name="txtEditAbleVal" placeholder="Value">
					</div>
				</div>
				<div class="row" style="display: none">
					<div class="col-25">
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" class='input' id="txtStockMinimum" name="txtStockMinimum" onkeyup="upAngka(this)">
						<label id="labelStokMinimum" class='labelForm' style="display:none;">Stok Minimum</label>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-75">
						<div class="autocomplete" style="min-width:200px;width:100%">
							<label id="labelSatuan" class='labelForm' style="display:none;">Satuan</label>
							<input type="text" class='input' id="txtSatuan" name="txtSatuan" placeholder="Satuan">
							<input type="hidden" id="satCek" name="satCek" placeholder="satCek">
						 </div>
					</div>
					<!-- <div class="col-25">
						<label for="txtStockMinimum">Satuan</label>
					</div>
					<div class="col-75">
        ...
        <div class="row" id="uploadGambar">
					...
					<div class="col-75">
                        ...
                        <input class='input' id="file" type="file" style="text-wrap:normal; text-align:center"  style="display:none;" />

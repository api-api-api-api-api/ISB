...
<!-- modal form -->
<div class="modal fade"  id="modalFormFUPB" role="dialog" aria-labelledby="modalFormFUPB" style="max-width: 80%; max-height: 91%; margin-left: 10%; margin-top: 2%;outline: 0;">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="border-radius: 6px;min-height: unset;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">FORM USULAN PRODUK BARU</h4>
                </div>
                ...
                <form name="fupbForm" id="fupbForm">
                    ...
                    <!-- col-md-offset-1 -->
                        <div class="col-md-12 ">
                            <div class="panel panel-primary" style="min-width:500px;border-color: #696969">
                                <div class="panel-body">
                                <input type="hidden" name="fupbId" id="fupbId">
                                    <p class="bg-info" style="padding: 15px;font-weight:bold;font-size:14px;" id="txtNoteReturn"></p>
                                    <table id="tableForm" width="100%">
                                        ...
                                        <tr><td>Komposisi & Dosis</td><td>:</td><td colspan="2"><textarea class="form-control" id="komposisi" name="komposisi" style="min-width:350px;width:100%"></textarea></td><td></td></tr>
                                        ...
                                        <tr><td>Jalur Registrasi</td><td>:</td><td colspan="2">
                                                <select name="jalurReg" id="jalurReg" class="form-control"  style='font-size:12px !important;width:50%;'></select>
                                                <!-- <input class="form-control" type="text" id="jalurReg" name="jalurReg" style="width:50%;display:none;"> -->
                                            </td><td></td></tr>
                                        <tr>
                                        ...
                                        <tr><td>Target Price</td>
                                            <td>:</td>
                                            <td>
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="basic-addon1">BOX</span>
                                                    <input type="text" class="form-control" id="targetPriceBox" name="targetPriceBox" style="width:100%" onKeyUp="upAngka(this)" style="text-align:right;">
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="targetPriceUnit" name="targetPriceUnit" style="width:100%" onKeyUp="upAngka(this)" style="text-align:right;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:30%;">
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="basic-addon1">Th. Pertama</span>
                                                    <input type="text" class="form-control" id="fcth1qty" name="fcth1qty" style="width:100%" onKeyUp="upAngka(this)" >
                                                    <span class="input-group-addon">QTY</span>
                                                </div> 
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="basic-addon1">Th. Kedua &nbsp;&nbsp;</span>
                                                    <input type="text" class="form-control" id="fcth2qty" name="fcth2qty" style="width:100%" onKeyUp="upAngka(this)" >
                                                    <span class="input-group-addon">QTY</span>
                                                </div>
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="basic-addon1">Th. Ketiga &nbsp;&nbsp;</span>
                                                    <input type="text" class="form-control" id="fcth3qty" name="fcth3qty" style="width:100%" onKeyUp="upAngka(this)" >
                                                    <span class="input-group-addon">QTY</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="fcth1value" name="fcth1value" style="width:100%" onKeyUp="upAngka(this)" >
                                                    <span class="input-group-addon">Value</span>
                                                </div> 
                                                <div class="input-group">
                                                   
                                                    <input type="text" class="form-control" id="fcth2value" name="fcth2value" style="width:100%" onKeyUp="upAngka(this)" >
                                                    <span class="input-group-addon">Value</span>
                                                </div>
                                                <div class="input-group">
                                                    
                                                    <input type="text" class="form-control" id="fcth3value" name="fcth3value" style="width:100%" onKeyUp="upAngka(this)" >
                                                    <span class="input-group-addon">Value</span>
                                                </div>
                                            </td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td colspan="2">
                                                <input type="radio" id="ujiBaY" name="ujiBa" value="Y"  checked>
                                                <label for="ujiBaY">Yes</label><br>
                                                <input type="radio" id="ujiBaN" name="ujiBa" value="N">
                                                <label for="ujiBaN">No</label>
                                            </td>
                                            <td></td>
                                        </tr>
                                    </table>
                            ...
                            <div class="panel panel-primary" style="border-color: #696969;">
                                ...
                                <div class='panel-footer'>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <span class="input-group-addon" id="basic-addon1">Info Tambahan</span>
                                                <textarea name="infoTambahan"  class="form-control" id="infoTambahan" cols="30" rows="10" style="width:100%"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel " style="min-width:500px;">
                                <div class="">
                                    <button type="button" class="btn btn-block btn-lg btn-danger" id="buttonSave" ><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button>    
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modalPembatalan" role="dialog" aria-labelledby="modalPembatalan" style="max-width: 30%; max-height: 91%; margin-left: 35%; margin-top: 2%;outline: 0;">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="border-radius: 6px;min-height: unset;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Pembatalan</h4>
                </div>
                <div class="modal-body" style="height: 350px;max-height: 350px;overflow-y:auto;">
                    <input type="hidden" id="txtIdFupb" name="txtIdFupb" >
                    <div class="form-group">
                        <input type="text" class="form-control" id="tglPembatalan" name="tglPembatalan" placeholder="Tanggal Pembatalan">
                    </div>
                    <div class="form-group">
                      <textarea name="txtAlasanPembatalan" class="form-control"id="txtAlasanPembatalan" cols="32" rows="10" style="background:rgb(255, 239, 213);resize:none" placeholder="Alasan Pembatalan"></textarea>
                    </div>
                    <button style="font-family:Arial !important;font-size:16px; font-weight:500;" type="button" class="btn btn-block btn-default btn-lg" id="tmblSavePembatalan" onclick="savePembatalan()" ><i class="fa  fa-floppy-o fa-fw" aria-hidden="true"></i> Simpan Pembatalan FUPB</button>
                </div>
                <div class="modal-footer">

				...
				<div class="form-horizontal">
					<div class="well has-warning">
                    	<div class="form-group clsJenis">
							...
							<div class="col-sm-3">
								<select id="txtGroup" name="txtGroup" class="form-control" onchange="getKategori()"><option value="ATK">ATK</option><option value="INVENTARIS">INVENTARIS</option><option value="PROMOSI">PROMOSI</option></select>
							</div>
							<div class="col-sm-6">
                        ...
                        <div class="form-group clsJenis">
							...
							<div class="col-sm-3">
								<select id="txtKategori" name="txtKategori" class="form-control" onchange="getData(1)"></select>
							</div>
							<div class="col-sm-6">

<?php
echo $this->Html->script('h1masterkategoriitem.js');
?>
<style type="text/css">
...
<header class="header">MASTER KATEGORI</header>
				...
				<div class="form-horizontal">
					<div class="well has-warning">
						...
						<div class="form-group clsKategori">
							...
							<div class="col-sm-2">
								<button type="button" class="btn btn-primary" onclick="saveKategori()"><i class="fa fa-plus-circle" aria-hidden="true"></i> Save</button>
							</div>
						</div>
					</div>
				</div>
			    ...
			    <div class="well has-success">
				    <table id="tableIsi"  class="table">
                        ...
                        <tr>
                            ...
                            <th style="text-align:center;"><input type="text" id="txtKategoriBarang" class="form-control" onkeyup="getData(1)" placeholder="cari nama"></th>

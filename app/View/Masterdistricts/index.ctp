...
<div class="row">
    <blockquote>Data Master district or its equivalent to this </blockquote>
            ...
            <div class="panel panel-default">
                <div class="panel-heading" >
                    <div class="row ">
                        ...
                        <div class="col-md-10 col-md-offset-0 text-right"><button type="button" class='btn btn-danger btn-sm'  id="btnAddDistrict"><i class="fa fa-plus-circle"> </i> ADD District</button></div>
                    </div>
                </div>
                <div class="panel-body" style="overflow-x:auto; padding-top:0;padding-bottom:0;" >
                <div class="row">
                    <table  id='tableMaintenanceDistrict' cellpadding="0" cellspacing="0" width="100%" class="table" style="border-radius: 5px;margin-bottom:0;"> 
                        <thead>
                            <tr class="active">
                                <th width="5%" style="text-align:center;vertical-align:middle">No</th> 
                                <th width="35%" style="text-align:left;vertical-align:middle">District</th>
                                <th width="15%" style="text-align:left;vertical-align:middle">City / Equivalent to a city</th>
                                <th width="15%" style="text-align:left;vertical-align:middle">Province / Equivalent to province </th>
                                <th width="10%" style="text-align:left;vertical-align:middle">Country </th>

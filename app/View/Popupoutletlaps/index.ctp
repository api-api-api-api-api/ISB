<?php
$this->layout='popup';
echo $this->Html->script('h1popupoutletlap.js');
?>
<h3>Pop Up Outlet</h3>
...
<table border="0" cellspacing="0" cellpadding="0">	
	...
	var colNames=['comId','outId','NamaOutlet','Alamat','Kota'];	
	var width=[0,0,150,150,100];
	var isHide={};
	var columntype={};
	var validation={};
	var cellsformat={};
	...
	<tr><td> <div id="linkHal" style="height:18px; font-weight:bold; display:none" ></div>
     ...
     <select name="namaKolom" class="roundIt">
	  <option value="out.nama">Nama Outlet</option>
	  </select>

...
public function getDataJenjanghirarki($namaKolom,$strCari){
	return $this->find('all', array(
						...
						array(
							...
							'type' => 'INNER',
							'conditions' => array(
								'group.ID= Jenjanghirarki.groupId'
							)
						),
				...
				'fields' => array('Jenjanghirarki.*','group.*'),
				'order' => 'Jenjanghirarki.id'
			));
	}
public function getDataJenjanghirarki2($namaKolom,$strCari){
	return $this->find('all', array(
				...
				'fields' => array('DISTINCT Jenjanghirarki.jenjangHirarki'),
				'order' => 'id'
			));
	}
